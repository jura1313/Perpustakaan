...
<div class="col-lg-8">
    <form method="POST" action="{{ url("/post-a-book") }}" enctype="multipart/form-data">
        @csrf
        <div class="mb-3">
          ...
          <div class="mb-3">
            ...
            <input class="form-control form-control-sm @error('book_cover') is-invalid @enderror" id="book_cover" name="book_cover" type="file">
            @error('book_cover')
            <div class="invalid-feedback">
                {{ $message }} Maximal Image Size 1.5MB
            </div>
          @enderror
          </div>
